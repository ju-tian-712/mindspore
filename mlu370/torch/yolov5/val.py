...
def run(
    ...
    LOGGER.info('testing cost time %.2f h', cost_time / 3600.)
    # Return results
...
def parse_opt():
    ...
    parser.add_argument("--device", default="mlu", help="mlu device, i.e. 0 or 0,1,2,3 or cpu")
...
def main(opt):
    ...
    if opt.task in ("train", "val", "test"):  # run normally
        ...
        opt.half = torch.mlu.is_available() and opt.device != "cpu"  # FP16 for fastest results
