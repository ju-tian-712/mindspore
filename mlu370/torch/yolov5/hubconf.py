...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    Args:
        ...
        device (str | torch.device | None, optional): Device to use for model parameters (e.g., 'cpu', 'mlu'). If None, selects
...
def custom(path="path/to/model.pt", autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        _verbose (bool): If True, prints all informational messages to the screen; otherwise, operates silently
            (default is True).
        device (str | torch.device | None): Device to load the model on, e.g., 'cpu', 'mlu', torch.device('mlu:0'), etc.
...
def yolov5s(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        device (str | torch.device | None, optional): Device to use for model computation, can be 'cpu', 'mlu', or
...
def yolov5m(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        device (str | torch.device | None, optional): Device specification to use for model parameters (e.g., 'cpu', 'mlu').
            Default is None.
...
def yolov5l(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        device (str | torch.device | None): Device to use for model parameters, e.g., 'cpu', 'mlu', or a torch.device instance.
            Default is None.
...
def yolov5x(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        device (str | torch.device | None): Device specification for computing the model, e.g., 'cpu', 'mlu:0', torch.device('mlu').
            Defaults to None.
...
def yolov5n6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        device (str | torch.device | None, optional): Device to use for model parameters. Can be 'cpu', 'mlu', or None.
            Default is None.
    ...
    Example:
        ```python
        import torch
        model = yolov5n6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device='mlu')
        ```
...
def yolov5s6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        device (str | torch.device | None): Device specification for model parameters (e.g., 'cpu', 'mlu', or torch.device).
...
def yolov5l6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        device (str | torch.device | None, optional): Device to use for model parameters, e.g., 'cpu', 'mlu', or torch.device.
